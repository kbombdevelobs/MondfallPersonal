...
SRC = src/main.c src/game.c src/player.c src/world.c src/world/world_noise.c src/world/world_draw.c src/weapon.c src/weapon/weapon_sound.c src/weapon/weapon_draw.c src/enemy/enemy_draw.c src/enemy/enemy_components.c src/enemy/enemy_spawn.c src/enemy/enemy_systems.c src/enemy/enemy_draw_ecs.c src/hud.c src/audio.c src/lander.c src/pickup.c src/combat_ecs.c src/sound_gen.c src/structure/structure.c src/structure/structure_draw.c src/ecs_world.c
