...
SRC = src/main.c src/game.c src/player.c src/world.c src/world/world_noise.c src/world/world_draw.c src/weapon.c src/weapon/weapon_sound.c src/weapon/weapon_draw.c src/enemy/enemy.c src/enemy/enemy_draw.c src/hud.c src/audio.c src/lander.c src/pickup.c src/combat.c src/sound_gen.c
OBJ = $(SRC:.c=.o)
TARGET = mondfall
