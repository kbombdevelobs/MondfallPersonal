---
title: "Mondfall — Nazis on the Moon FPS (AGENTS Mirror)"
status: Active
owner_area: Core
created: 2026-04-04
...
`AGENTS.md` is the agent-facing mirror of the root `CLAUDE.md`. Keep both files synchronized when architecture, workflow, or documentation rules change.
...
```
AGENTS.md (this file)        ← agent-facing mirror of the root guide
CLAUDE.md                    ← canonical root doc for the current documentation system
...
|----------|-----------------|
| Whole-app architecture | `CLAUDE.md` (mirrored here in `AGENTS.md`) |
...
5. Keep `AGENTS.md` and `CLAUDE.md` synchronized when root guidance changes

### Maintenance Protocol

On every pass that changes code, structure, or documentation, check whether updates are needed for:

- **This file and `CLAUDE.md`** — if app-level architecture, major folders, or doc rules change
